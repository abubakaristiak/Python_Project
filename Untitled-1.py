...
#     # Add leader names to the members list
#     members.extend(leader_names)
...
#     # Distribute non-leader members into groups
#     group_index = 0
#     for member in members:
#         # If the group is full, move to the next group
...
# # Example usage
# leader_names = ["Saiyam", "Ajmire", "Jaynab"]  # Example group leader names
# member_names = ["Tuhid", "Istiak", "Israt", "Isnan", "Dider", "Swarup", "Shojib", "shaluk"]  # Example member names
# group_size = 4  # Example group size
